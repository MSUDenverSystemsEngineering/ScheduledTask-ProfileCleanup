...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'ScheduledTask: Profile Cleanup'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		#Copy PSAPP Files
		Copy-File -Path "$dirFiles\Profile-Cleanup" -Destination "$envWinDir\Management" -Recurse

		#Create Scheduled Task
		schtasks.exe /Create /TN "Profile-Cleanup" /XML "$dirFiles\Profile-Cleanup.xml"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-File -Path "$envWinDir\Management\Profile-Cleanup" -Recurse

		#Remove Scheduled Task
		schtasks.exe /DELETE /TN "Profile-Cleanup" /F
